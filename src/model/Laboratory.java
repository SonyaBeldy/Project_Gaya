...
public class Laboratory extends Outpost {
    ...
    public Laboratory(Player player) {
        super(5, 3, "./view/resourses/images/buildings/" + player.getRace() + "/2.png", new int[]{0, 1, 1, 1}, 2);
        setFitWidth(30);
        setFitHeight(31);
        setImage(new Image("./view/resourses/images/buildings/" + player.getRace() + "/2.png"));
    }
